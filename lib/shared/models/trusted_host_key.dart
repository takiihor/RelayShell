...
class TrustedHostKey {
  ...
  /// The host record associated after this key was trusted. Advisory only;
  /// endpoint and key type are the actual trust identity, and this can be null
  /// when the user tests a new computer before saving its form.
  final String? hostId;
  ...
  factory TrustedHostKey.fromRow(Map<String, Object?> row) => TrustedHostKey(
    ...
    trustedAt: DateTime.fromMillisecondsSinceEpoch(row['trusted_at']! as int),
  );
